...
#import "UIButton+XWStatistics.h"
...
@implementation UIButton (XWStatistics)
...
- (void)xw_clicked:(UIButton *)sender{
    ...
    NSLog(@"%@ 按钮点击 %ld次 ",[sender titleForState:UIControlStateNormal], self.btnClickedCount);
    NSLog(@"按钮路径：%@",[sender viewPathString]);
